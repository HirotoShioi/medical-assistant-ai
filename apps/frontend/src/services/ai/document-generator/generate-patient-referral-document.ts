...
const config: GenerateDocumentConfig = {
  ...
  sectionGeneratorParam: [
    {
      title: "入院に至る経緯",
      instructions: `あなたは優秀な医療情報専門家です。以下のテキストから、診療情報提供書の「入院に至る経緯」セクションを作成してください。`,
      example: codeBlock`
    ...
    {
      title: "入院後の経過",
      instructions: `あなたは優秀な医療情報専門家です。以下のテキストから、診療情報提供書の「入院後の経過」セクションを作成してください。`,
      example: codeBlock`
        入院後、徐々に意識レベルは改善しましたが、依然として認知機能には障害が残っています。検査結果からはWernicke脳症が疑われ、ビタミンB1の投与が行われました。`,
    },
    {
      title: "現在の処方内容",
      instructions: `あなたは優秀な医療情報専門家です。以下のテキストから、診療情報提供書の「現在の処方内容」セクションを作成してください。`,
      example: codeBlock`
        - タケキャブ20mg 1T 1x 朝食後
    ...
    {
      title: "既往歴及び家族歴",
      instructions: `あなたは優秀な医療情報専門家です。以下のテキストから、診療情報提供書の「既往歴及び家族歴」セクションを作成してください。`,
      example: codeBlock`
        【既往歴/併存症】
    ...
    {
      title: "備考",
      instructions: `あなたは優秀な医療情報専門家です。以下のテキストから、診療情報提供書の「備考」セクションを作成してください。`,
      example: codeBlock`
